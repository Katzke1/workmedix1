            ...
            <tr>
              <td style="vertical-align:middle;">
                <img src="${APP_URL}/images/logo-white.png" alt="Workmedix"
                     height="42" style="display:block;height:42px;width:auto;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;color:#ffffff;font-size:18px;font-weight:800;letter-spacing:0.12em;">
              </td>
