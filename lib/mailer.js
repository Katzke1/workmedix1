  ...
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(35,38,242,.08);">
      ...
      <tr><td style="padding:40px;">
        ...
        <p style="margin:0;color:#b2bec3;font-size:.78rem;text-align:center;">
          Workmedix · 074 716 3079 · info@workmedix.co.za
        </p>
      </td></tr>
    </table>
  </td></tr>
...
module.exports = { sendVerificationEmail, sendTestEmail, sendContactNotification, sendContactConfirmation, sendPasswordResetEmail, sendBookingConfirmationEmail };
