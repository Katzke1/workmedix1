      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(35,38,242,.08);">
        ...
        <tr><td style="padding:40px;">
          ...
          <div style="text-align:center;margin:32px 0;">
            <a href="${link}" style="display:inline-block;background:linear-gradient(135deg,#1416B8,#2326F2);color:#ffffff;text-decoration:none;font-weight:700;font-size:1rem;padding:14px 36px;border-radius:8px;letter-spacing:.01em;">
              Verify My Email
            </a>
          </div>
...
async function sendTestEmail(toEmail) {
  await sendEmail({
    ...
    html: `<p style="font-family:Arial,sans-serif;">✅ Brevo HTTP API is working correctly. Sent from <strong>${FROM_EMAIL}</strong>.</p>`,
  });
}
    ...
    <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(35,38,242,.08);">
      ...
      <tr><td style="padding:40px;">
        ...
        <div style="text-align:center;margin:28px 0;">
          <a href="${APP_URL}/register" style="display:inline-block;background:linear-gradient(135deg,#1416B8,#2326F2);color:#ffffff;text-decoration:none;font-weight:700;font-size:.95rem;padding:13px 32px;border-radius:8px;">
  ...
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(35,38,242,.08);">
      ...
      <tr><td style="padding:40px;">
        ...
        <div style="text-align:center;margin:32px 0;">
          <a href="${link}" style="display:inline-block;background:linear-gradient(135deg,#1416B8,#2326F2);color:#fff;text-decoration:none;font-weight:700;font-size:1rem;padding:14px 36px;border-radius:8px;">
            Reset My Password
          </a>
        </div>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f6fb;padding:40px 20px;">
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(35,38,242,.08);">
      ...
      <tr><td style="padding:40px;">
        <h2 style="margin:0 0 12px;color:#1416B8;font-size:1.25rem;font-weight:700;">Hi ${toName},</h2>
        <p style="margin:0 0 24px;color:#3A3A4A;font-size:.95rem;line-height:1.7;">Your booking has been confirmed. Here are the details:</p>
        ...
        <div style="text-align:center;margin:28px 0;">
          <a href="${APP_URL}/portal/bookings" style="display:inline-block;background:linear-gradient(135deg,#1416B8,#2326F2);color:#fff;text-decoration:none;font-weight:700;font-size:.95rem;padding:13px 32px;border-radius:8px;">
            View My Bookings
          </a>
        </div>
        <hr style="margin:28px 0;border:none;border-top:1px solid #E4E6F0;">
        <p style="margin:0;color:#b2bec3;font-size:.78rem;text-align:center;">Workmedix · 074 716 3079 · info@workmedix.com</p>
      </td></tr>
    </table>
  </td></tr>
</table></body></html>`,
    ...
    <table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 16px rgba(20,22,184,.08);">
      ...
      <tr><td style="padding:36px 40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #E4E6F0;border-radius:8px;overflow:hidden;margin-bottom:28px;">
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;width:38%;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Company</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;">${companyName || '—'}</td></tr>
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Contact</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;">${contactName} &lt;<a href="mailto:${contactEmail}" style="color:#2326F2;">${contactEmail}</a>&gt;</td></tr>
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Service</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;font-weight:600;">${serviceType}</td></tr>
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Preferred Date</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;">${preferredDate}</td></tr>
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Location</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;">${locationText || '—'}</td></tr>
          <tr><td style="padding:11px 16px;background:#F5F6FB;border-bottom:1px solid #E4E6F0;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Headcount</strong></td><td style="padding:11px 16px;border-bottom:1px solid #E4E6F0;color:#0A0A0F;font-size:.95rem;">${numPeople} employee${numPeople !== 1 ? 's' : ''}</td></tr>
          ${notes ? `<tr><td style="padding:11px 16px;background:#F5F6FB;"><strong style="color:#1416B8;font-size:.77rem;text-transform:uppercase;letter-spacing:.05em;">Notes</strong></td><td style="padding:11px 16px;color:#0A0A0F;font-size:.92rem;line-height:1.6;">${notes.replace(/\n/g, '<br>')}</td></tr>` : ''}
        </table>
        <div style="text-align:center;margin:8px 0 28px;">
          <a href="${adminLink}" style="display:inline-block;background:linear-gradient(135deg,#1416B8,#2326F2);color:#ffffff;text-decoration:none;font-weight:700;font-size:.95rem;padding:13px 36px;border-radius:8px;letter-spacing:.01em;">
